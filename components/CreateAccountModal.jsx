      ...
      {showModal ? (
        <>
            <div
                ...
                className='overflow-auto fixed inset-0 z-[70] outline-none focus:outline-none'
            >
                <div
                    ...
                    <div className='border-0 rounded-lg shadow-xl relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                        ...
                        <div className='relative py-6 px-[30px] flex-auto flex items-start justify-between'>
                            <div className="flex flex-col items-start justify-start w-[50%]">
                                <p className="font-bold text-black text-2xl pb-6">Create Account</p>
                                ...
                                <form className='max-w-[320px]'>
                                    ...
                                    <div className="cursor-pointer border-solid border-[0.6px] border-[#D9D9DB] w-full rounded-sm p-3 flex items-center justify-center">
                                        <Image
                                            src={GoogleIcon}
                                            alt="/"
                                            width={16}
